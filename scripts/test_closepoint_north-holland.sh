...
psql -d $DBNAME -v point="'SRID=4326;POINT(4.8594 52.3576)'" -f sql/test_closestpoint.sql
...
psql -d $DBNAME -v point="'SRID=4326;POINT(4.9412 52.3302)'" -f sql/test_closestpoint.sql
